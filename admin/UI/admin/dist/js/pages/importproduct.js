...
function uploadCompleted(response) {
    swal(response.msg + ' You can Update PRODUCT IMAGE in View/Edit Product')
        .then((value) => {
            location.reload();
        });
...
function setFileName() {
    $('#product_filename').val($('#product_file').val());
}
